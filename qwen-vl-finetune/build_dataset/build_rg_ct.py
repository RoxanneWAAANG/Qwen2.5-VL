...
instruction_templates = [
    ...
    "Review the radiology image and provide a comprehensive diagnostic report.",
    "Interpret this radiology image and summarize all significant findings.",
    ...
    "Evaluate the radiology image and draft a structured radiology report.",
    ...
    "Examine the radiology image and describe any notable abnormalities or variations.",
    "Create a narrative radiology report from the attached radiology scan.",
    "Write a radiologist's report based on the radiology scan provided.",
    "Review the attached radiology scan and produce a professional report.",
    "Create a structured report summarizing the key radiological findings.",
    "Interpret the radiology scan below and generate a report suitable for clinical review.",
    "Could you please review this radiology image and generate a report?",
    "Can you interpret the attached radiology image and summarize your findings?",
    "Would you mind providing a radiology report for this radiology image?",
    "Can you help by writing a diagnostic report based on this radiology scan?",
    "Could you describe what this radiology image shows?",
    "Would you be able to draft a full clinical report for this radiology image?",
    "Can you generate a professional radiology radiology summary from this image?",
    "Could you analyze this radiology scan and outline the major findings?",
    "Would you provide your interpretation of this radiology image?",
    "Could you offer a comprehensive report based on the attached radiology image?",
    "Please provide a structured diagnostic radiology report for this scan.",
    "Can you prepare a full read of the radiology scan results in report format?",
    "What do you see in this radiology image?",
    "Is there anything abnormal in the radiology scan?",
    "What are your observations from this radiology image?",
    "Can you tell what might be wrong from this radiology scan?",
    "Does anything stand out in this radiology image?",
    "How would you interpret this radiology scan?",
    "What are the key features seen in the radiology image?",
    "What is your diagnostic impression of this radiology image?",
    "What findings should be noted in this radiology scan?",
    "What can you infer from this radiology scan?",
    "Can you walk me through your radiological interpretation?",
    "What should a radiologist say about this scan?",
    "Do you notice anything concerning in this radiology image?",
    "What might this radiology scan indicate clinically?",
    ...
    "Pretend you are documenting for a hospital EMR system — report this radiology scan.",
    "Generate a diagnostic radiology report to support a referring physician.",
    "You're reviewing this radiology scan for surgical planning — provide your full read.",
